...
export default async function RecurringPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader
        title="Recurring"
        description="Money that arrives or leaves on a schedule. Spendly records each occurrence automatically — configure it once."
        actions={<RecurringRuleDialog triggerLabel="Add recurring" />}
      />
